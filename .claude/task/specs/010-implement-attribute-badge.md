# TASK: Create AttributeBadge Components
# TYPE: implement
# PRIORITY: high
# TIMEOUT: 10

## Objective
Create reusable badge components for displaying cut attributes at `src/components/AttributeBadge.tsx`.

## Context
Badges display toughness, fat content, price, marbling in a visual way. Uses Tailwind.

## Deliverables
Create `/Users/dennyleonardo/Downloads/beef-cuts/src/components/AttributeBadge.tsx`:

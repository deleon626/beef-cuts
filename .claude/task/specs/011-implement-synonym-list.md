# TASK: Create SynonymList Component
# TYPE: implement
# PRIORITY: high
# TIMEOUT: 10

## Objective
Create a component to display international beef cut synonyms at `src/components/SynonymList.tsx`.

## Context
Each cut has synonyms in USA, UK, Australia, Japanese, French, Korean. Display with country flags/labels.

## Deliverables
Create `/Users/dennyleonardo/Downloads/beef-cuts/src/components/SynonymList.tsx`:
...
## Success Criteria
- [ ] Full view with all regions grouped
- [ ] Compact view for cards/previews
- [ ] Flag emojis for each region
- [ ] IMPS/NAMP code display

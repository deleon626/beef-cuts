...
## Objective
Create a multi-attribute filter bar for the cuts grid at `src/components/FilterBar.tsx`.

## Context
Filters: primal cut, toughness range, fat content, price range, cooking method, Tokusen availability.

## Deliverables
Create `/Users/dennyleonardo/Downloads/beef-cuts/src/components/FilterBar.tsx`:
...
export const FilterBar: React.FC<FilterBarProps> = ({ filters, onChange, resultCount }) => {

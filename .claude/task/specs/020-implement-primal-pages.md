# TASK: Create Primal Cut Pages
# TYPE: implement
# PRIORITY: high
# TIMEOUT: 10

## Objective
Create dynamic primal cut pages at `src/pages/primal/[primal].astro`.

## Context
Pages that show all cuts from a specific primal region with information about that primal.

## Deliverables
Create `/Users/dennyleonardo/Downloads/beef-cuts/src/pages/primal/[primal].astro`:
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <header class="mb-12">
      <div class="flex items-center gap-4 mb-4">
        <span class="text-5xl">{primal.icon || '🥩'}</span>
        <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        ...
        <div class="flex flex-wrap gap-2">
          {primal.typicalCookingMethods.slice(0, 4).map((method) => (
